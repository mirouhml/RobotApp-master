...
public class MentalCalculationsLevel3 extends AppCompatActivity {
    private final LoadingDialogue dialogue = new LoadingDialogue(MentalCalculationsLevel3.this);
