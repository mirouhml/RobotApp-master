...
public class MentalCalculationsLevel1 extends AppCompatActivity {
    private final LoadingDialogue dialogue = new LoadingDialogue(MentalCalculationsLevel1.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mental_calculations_level1);
